...
export class TechnologyTypeGroup implements IAuditedNameDataType {
  ...
  public toString(): string {
    return 'TechnologyTypeGroup: id=' + this.id + ' name=' + this.name + ' versionStatus=' + this.versionStatus + ' versionCreatedBy=' + this.versionCreatedBy +
